...
export function StatParent() {
    return (
        <StatsProvider>
            <div className="py-4 px-8 max-xl:px-4 pb-12 fixed-content-area w-full gap-4 flex flex-col justify-start items-start align-top fixed-content-area no-scrollbar">
                <Outlet />
                <StatMenu />
            </div>
        </StatsProvider>
